...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden">
      {/* CTA block */}
      <div className="bg-green-600 py-24 px-6 md:px-8">
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
            <Link
              href="/signup"
              className="bg-white text-green-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-50 transition-colors shadow-xl shadow-green-900/20"
            >
              Sign Up Free
            </Link>
            <Link
          ...
          <p className="text-green-200 text-sm mt-6">
            Have any questions?{' '}
            <Link href="/contact" className="underline text-white hover:text-green-100">
              Contact us
            </Link>
          </p>
        </div>
        ...
        {/* Background blobs */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-green-500/30 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-green-500/30 rounded-full blur-3xl" />
      </div>
