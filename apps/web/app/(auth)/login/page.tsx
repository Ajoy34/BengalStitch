    ...
    <div className="w-full max-w-md space-y-8 bg-white p-10 rounded-3xl card-shadow">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between items-center">
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" className="rounded border-outline accent-primary" />
            Remember me
          </label>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-4 bg-white text-on-surface-variant">or</span>
        </div>
      </div>
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-surface-dim">
      <Suspense fallback={
        <div className="w-full max-w-md bg-white p-10 rounded-3xl card-shadow animate-pulse">
